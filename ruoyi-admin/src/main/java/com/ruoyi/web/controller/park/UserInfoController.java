...
public class UserInfoController extends BaseController {
    ...
    @Log(title = "查询用户", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(UserInfo userInfo) {
        List<UserInfo> list = userInfoService.selectUserInfoList(userInfo);
        ExcelUtil<UserInfo> util = new ExcelUtil<UserInfo>(UserInfo.class);
        return util.exportExcel(list, "查询用户数据");
    }
    ...
    @Log(title = "查询用户", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
     ...
     */
    @RequiresPermissions("park:queryUser:edit")
    @Log(title = "查询用户", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "查询用户", businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    @ResponseBody
